...
- (void)setLeftNavTitle:(NSString *)title{
    DoraemonNavBarItemModel *item = [[DoraemonNavBarItemModel alloc] initWithText:title color:[UIColor doraemon_blue] selector:@selector(leftNavTitleClick:)];
...
- (void)leftNavTitleClick:(id)clickView{
